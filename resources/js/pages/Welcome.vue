...
<template>
    ...
    <div class="min-h-screen bg-background">
        ...
        >
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="mx-auto max-w-3xl text-center">
                    ...
                    <!-- Subheadline -->
                    <p
                        class="mt-6 text-lg leading-8 text-muted-foreground sm:text-xl"
                    >
                        Get real-time push notifications when your favorite
                        streamers go live. Track stream history, manage
                        subscriptions, and never miss a moment.
                    </p>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <path
                                    d="M4.64 0L1 6v17h7V24l2.75-2.75h4.75L23 14.5V0H4.64zM20 13.5L15 18H10.25L8 20.25V18H4V2h16v11.5z"
                                />
        ...
        <section
            id="screenshots"
            class="bg-muted/50 py-16 sm:py-24 dark:bg-muted/20"
        >
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <!-- Section Header -->
                <div class="mx-auto max-w-2xl text-center">
                    ...
                    <p class="mt-4 text-lg text-muted-foreground">
                        Built with Vue 3 and Tailwind CSS for a seamless
                        experience
                    </p>
                </div>
                ...
                >
                    ...
                    <Card
                        class="overflow-hidden border-border/50 dark:border-border"
                    >
                        ...
                        <CardHeader>
                            <CardTitle class="text-lg"
                                >Live Stream Dashboard</CardTitle
                            >
                            <CardDescription>
                                See all your favorite streamers in one place
                    ...
                    >
                        ...
                        <CardHeader>
                            <CardTitle class="text-lg"
                                >Subscription Management</CardTitle
                            >
                            <CardDescription>
                                Easily manage which streamers you want to track
                    ...
                    <Card
                        class="overflow-hidden border-border/50 sm:col-span-2 lg:col-span-1 dark:border-border"
                    >
                        <div class="aspect-video overflow-hidden bg-muted">
                            <img
                        ...
                        <CardHeader>
                            <CardTitle class="text-lg"
                                >Complete Stream History</CardTitle
                            >
                            <CardDescription>
                                View a detailed timeline of when your favorite
                                streamers went live
                            </CardDescription>
                        </CardHeader>
                    </Card>
        ...
        <section id="features" class="bg-background py-16 sm:py-24">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mx-auto max-w-2xl text-center">
                    ...
                    <p class="mt-4 text-lg text-muted-foreground">
                        Powerful features to keep you connected with your
                        favorite Twitch content
                    </p>
                </div>
                ...
                <div class="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="flex flex-col items-start gap-4">
                        <div
                            class="flex size-12 items-center justify-center rounded-lg bg-primary/10 text-primary dark:bg-primary/20"
                        >
                            <LogIn class="size-6" />
                        </div>
                        <div>
                            ...
                            <p class="mt-2 text-muted-foreground">
                                Securely sign in with your Twitch account using
                                OAuth 2.0
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-muted-foreground">
                                Instant notifications powered by Twitch EventSub
                                webhooks
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-muted-foreground">
                                Get push notifications when streamers go live,
                    ...
                    <div class="flex flex-col items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-muted-foreground">
                                Track your favorite streamers and their
                    ...
                    <div class="flex flex-col items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-muted-foreground">
                                View a complete timeline of stream events and
                                activity
                            </p>
                        </div>
                    </div>
            ...
            <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div class="flex gap-6">
                        ...
                        <TextLink :href="login()" class="text-sm">
                            Sign In
                        </TextLink>
                    </div>
                </div>
