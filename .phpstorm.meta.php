...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mishaa/2025-dev/obsvr/public/storage' => 'string',
...
'view.paths','view.compiled','concurrency.default','broadcasting.default','broadcasting.connections.reverb.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mishaa/2025-dev/obsvr/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'inertia.testing.page_extensions','inertia.history.encrypt','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'octane.cache.bytes','octane.watch','octane.garbage','octane.max_execution_time','queue.default',
...
'debugbar.options.gate.trace','debugbar.options.db.with_params','debugbar.options.db.exclude_paths','debugbar.options.db.backtrace','debugbar.options.db.backtrace_exclude_paths',
...
'debugbar.queries.explain','home','dashboard','twitch','profile.edit','profile.update','profile.destroy','password.edit',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','app.dashboard.title',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','OCTANE_SERVER',);
